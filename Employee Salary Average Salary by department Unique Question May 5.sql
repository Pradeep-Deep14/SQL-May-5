...
SELECT EMP_NO,EMP_NAME,DEPARTMENT FROM EMPLOYEES
GROUP BY DEPARTMENT,EMP_NO,EMP_NAME,SALARY
...
--Find the employee who has less than average salary across company
